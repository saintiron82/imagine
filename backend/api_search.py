...
def format_result(result: dict, skip_fs: bool = False) -> dict:
    ...
    formatted = {
        ...
        "spatial_score": result.get("spatial_score"),
        ...
        "spatial_matches": result.get("spatial_matches", []),
        "spatial_processing_quality": result.get("spatial_processing_quality", {}),
        "metadata_reliability_score": result.get("metadata_reliability_score"),
        "caption_reliability": result.get("caption_reliability"),
        "tag_reliability": result.get("tag_reliability"),
        "metadata_quality_source": result.get("metadata_quality_source"),
        "metadata_quality_confidence": result.get("metadata_quality_confidence"),
        "metadata_quality_issues": result.get("metadata_quality_issues", []),
        "metadata_quality_basis": result.get("metadata_quality_basis", []),
        "metadata_quality_adjustment": result.get("metadata_quality_adjustment"),
