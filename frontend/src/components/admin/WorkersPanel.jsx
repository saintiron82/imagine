        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-gray-700 text-gray-400 text-xs">
              ...
              <th className="text-left px-2 py-2">{t('admin.worker_current_task')}</th>
                      ...
                      <div className="flex items-center gap-1.5">
                        {phaseLabel && (
                          <span className={`px-1.5 py-0.5 rounded text-[10px] font-bold shrink-0 ${
                            phaseLabel === 'MC' ? 'bg-purple-500/20 text-purple-300' :
                            phaseLabel === 'VV' ? 'bg-blue-500/20 text-blue-300' :
                            phaseLabel === 'MV' ? 'bg-green-500/20 text-green-300' :
                            'bg-sky-500/20 text-sky-300'
                          }`}>{phaseLabel}</span>
                        )}
                        <span className="text-xs text-gray-300 truncate max-w-[160px]" title={w.current_file}>{fileName}</span>
                      </div>
                    ) : (
